...
**ยังไม่มีงานออกแบบ** — v0 เป็น HTML เปล่าไม่มี CSS โดยตั้งใจ เพราะโจทย์ของ v0 คือพิสูจน์ว่ากลไกยอดเงินถูกต้อง ไม่ใช่ว่าหน้าตาดี

การลงแรงกับหน้าตาก่อนรู้ว่าจะใช้งานจริงยังไง มีโอกาสสูงที่จะต้องรื้อทิ้ง — ภาพหน้าจอจะใส่ตอนมี UI จริงหลังใช้เองครบหนึ่งเดือน
