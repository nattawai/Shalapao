...
- [x] **ปุ่มเช็คยอด** — ไหลสามขั้น (คำนวณยอด rollup ณ วันปิดงวด → กรอกยอดจริง เห็นส่วนต่างสด → ยืนยันปิดงวด) · date picker ล็อกให้เลือกได้แค่อดีต · ต้องเห็นส่วนต่างก่อนยืนยันเสมอ
